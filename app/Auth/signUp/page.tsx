            ...
            <div className="flex flex-col w-full gap-[40px] h-full items-center pt-[60px] px-4 pb-4 flex-nowrap overflow-scroll">
                ...
                <form className="flex flex-col w-full max-w-[600px] items-center gap-8 justify-center">
                    ...
                    <InputComponent label="Email" required={true} placeholder="Enter your email" type="email" name="email" value="" hasAnError={false}
                        width="w-full " onChange={() => { }} errorMessage={"Ha ocurrido un error, complete el campo correspondiente"} />

                    <InputComponent label="password" required={true} placeholder="Password" type="password" name="password" value="" hasAnError={false}
                        width="w-full " onChange={() => { }} errorMessage={"Ha ocurrido un error, complete el campo correspondiente"} />

                    <div className="w-full text-[14px] flex justify-between">
                        <CheckBoxWithLabel label={"Remember me"} id={"recuerdame"} checked={false as boolean} onChange={() => { }} />
