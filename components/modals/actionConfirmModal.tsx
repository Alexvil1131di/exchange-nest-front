...
const ActionConfirm = ({ title, actionMessage, acctionConfirm, acctionReject, confirmButtonLabel, rejectButtonLabel = '', mainColor = "bg-[#FF0000]", backGround = "bg-[#0C9281]" }) => {
        ...
        <>
            <div className={`fixed top-0 left-0 right-0 bottom-0 flex justify-center items-center bg-[#000000a6] z-[99]`}>
                <div className="bg-white rounded-[8px] w-full max-w-md flex flex-col gap-4">
                    <div className={`flex items-center w-full ${backGround} h-[56px] rounded-t-[8px]`}>
