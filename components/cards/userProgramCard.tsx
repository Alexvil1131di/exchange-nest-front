...
const UsersProgramCard = () => {
    return (
        <div className="flex flex-col w-full md:w-[330px] h-[510px]  rounded-[20px] shadow-lg shadow-[#D9D9D9] p-4  ">
            ...
            <div className='mt-auto'>
                <Link className='flex items-center text-[16px] text-[#252525] font-normal underline' href="#">{"Apply Now >"} </Link>
            </div>
        </div>
